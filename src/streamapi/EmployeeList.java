...
public class EmployeeList {
	...
	public static void main(String args[]) {
		...
		employeeList.add(new Employee(166, "Moin Shaikh", 43, "Male", "Security And Transport", 2016, 10500.0));
		employeeList.add(new Employee(177, "Manav Sharma", 35, "Male", "Account And Finance", 2010, 27000.0));
		employeeList.add(new Employee(188, "Ding Li", 31, "Male", "Product Development", 2015, 34500.0));
		employeeList.add(new Employee(199, "Amelia Zoe", 24, "Female", "Sales And Marketing", 2016, 11500.0));
		employeeList.add(new Employee(200, "Jaden Smith", 38, "Male", "Security And Transport", 2015, 11000.5));
		employeeList.add(new Employee(211, "Simmy Kaur", 27, "Female", "Infrastructure", 2014, 15700.0));
		employeeList.add(new Employee(222, "Nitin Joshi", 25, "Male", "Product Development", 2016, 28200.0));
		employeeList.add(new Employee(233, "Arjun Reddy", 27, "Female", "Account And Finance", 2013, 21300.0));
		employeeList.add(new Employee(244, "Nicolus Den", 24, "Male", "Sales And Marketing", 2017, 10700.5));
		employeeList.add(new Employee(255, "Ali Ansari", 23, "Male", "Infrastructure", 2018, 12700.0));
		employeeList.add(new Employee(266, "Sanvi Pandey", 26, "Female", "Product Development", 2015, 28900.0));
		employeeList.add(new Employee(277, "Anuj Darbar", 31, "Male", "Product Development", 2012, 35700.0));
		...
		Map<String, Double> averagesalary = employeeList.stream().collect(
				Collectors.groupingBy(Employee::getDepartment, Collectors.averagingDouble(Employee::getSalary)));
		for (Map.Entry<String, Double> entry : averagesalary.entrySet()) {
			System.out.println(entry.getKey() + " : " + entry.getValue());
		}

		Optional<Employee> getnameOptional = employeeList.stream()
		...
		Employee employee = getnameOptional.get();
		...
		Employee employee1 = mostworkingexperience.get();
		...
		Optional<Employee> employeebyage = employeeList.stream().max(Comparator.comparing(Employee::getAge));
		Employee employeebyage1 = employeebyage.get();
